...
![Visualization of local curvature field on various biological specimens identified by their MorphoSource media identifiers. Positive curvature regions are shaded red, and negative curvature regions are shaded blue. \label{visualization-demo.png}](visualization-demo.png)
